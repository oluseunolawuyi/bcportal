...
$activity = "Deleted {$i} CV cover letter(s) 2.";
...
if($_SERVER["REQUEST_METHOD"] == "POST" && !empty($edit) && !empty($client) && !empty($completion_date) && !empty($details_category)){
...
if($act){
$error = 0;
echo "<div class='success'>CV cover letter 2 successfully updated.</div>";
}else{
echo "<div class='not-success'>Error. Unable to update CV cover letter 2.</div>";
}
}
///////////////////////////////////////////////////////////////////////////////
...
$where = "WHERE cover_letter_type = '3'";
...
$page_link = "{$admin}new-cv-cover-letter?pn=";
$link_suffix = "";
...
<div class="page-title">CV Cover Letter 2 <a href="<?php echo $admin; ?>new-cv-cover-letter?add=1" class="btn gen-btn general-link float-right">New Cover Letter</a></div>

<form action="<?php echo $admin; ?>new-cv-cover-letter" name="search_form" class="general-form" id="form-div" method="post" runat="server" autocomplete="off" enctype="multipart/form-data">
...
?>
<form action="<?php echo $admin; ?>new-cv-cover-letter" class="general-form" id="form-div" method="post" runat="server" autocomplete="off" enctype="multipart/form-data" style="overflow-x:auto;">
...
<td><a href="<?php echo $admin; ?>new-cv-cover-letter?edit=<?php echo $letter_id; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn general-link" title="Edit CV cover letter #<?php echo $letter_id; ?>"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a></td>
<td><a href="<?php echo $admin; ?>new-cv-cover-letter?view=<?php echo $letter_id; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn general-link" title="View CV cover letter #<?php echo $letter_id; ?>"><i class="fa fa-eye" aria-hidden="true"></i> View</a></td>
...
echo "<div class='not-success'>No CV cover letter 2 found at the moment.</div>";
}
...
<div class="back"><a href="<?php echo $admin; ?>new-cv-cover-letter?pn=<?php echo $pn; ?>" class="btn gen-btn general-link"><i class="fa fa-arrow-left"></i> Back to CV cover letters</a></div>
...
$value_array = explode("+*+*",$value);
$names = $value_array[0];
$institution = $value_array[1];
$qualification = $value_array[2];
$course = $value_array[3];
$grade = $value_array[4];
$session = $value_array[5];
$comment = $value_array[6];
$transaction_ref = $value_array[7];
?>
<tr>
<td><?php echo $c; ?></td>
<td><?php echo $names; ?></td>
<td><?php echo $institution; ?></td>
<td><?php echo $qualification; if(!empty($qualification) && !empty($course)){ echo " ({$course})"; }else{ echo $course; } ?></td>
...
<a href="<?php echo $admin; ?>new-cv-cover-letter?edit=<?php echo $view; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn general-link float-right" title="Edit this cover letter"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
</form>
</div>
...
echo "<div class='not-success'>This CV cover letter 2 does not exist.</div>";
}
}
...
$client = $completion_date = $attention = $reference_no = $client_designation = $re = $invoice_attachment = $signatory = $batch_category = $details_category = $list_category = "";
if(!empty($edit)){
...
<div class="back">
<a href="<?php echo $admin; ?>new-cv-cover-letter?view=<?php echo $edit; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn general-link"><i class="fa fa-arrow-left"></i> Back to view letter</a>
</div>

<div class="page-title"><?php echo $action_title; ?> CV Cover Letter 2</div>

<?php if(!empty($edit)){ ?>

<form action="<?php echo $admin; ?>new-cv-cover-letter" class="general-form" id="form-div" method="post" runat="server" autocomplete="off" enctype="multipart/form-data" style="border:1px solid #eee;">
<input type="hidden" name="gh" value="1"> 
...
<th class="gen-title">Institution</th>
<th class="gen-title">Qualification</th>
<th class="gen-title">Course</th>
</tr>
<tr>
<td><input type="text" name="names[]" id="names" class="form-control" placeholder="Candidate names" value="<?php echo $names; ?>"></td>
<td><input type="text" name="institution[]" id="institution" class="form-control" placeholder="E.g. University of Lagos" value="<?php echo $institution; ?>"></td>
<td><input type="text" name="qualification[]" id="qualification" class="form-control" placeholder="E.g. BSc" value="<?php echo $qualification; ?>"></td>
...
<th class="gen-title">Session</th>
<th class="gen-title">Comment</th>
<th class="gen-title">Transaction Ref.</th>
</tr>
<tr>
<td><input type="text" name="grade[]" id="grade" class="form-control" placeholder="Ist Class" value="<?php echo $grade; ?>"></td>
<td><input type="text" name="session[]" id="session" class="form-control" placeholder="E.g. 2009/2010" value="<?php echo $session; ?>"></td>
<td><input type="text" name="comment[]" id="comment" class="form-control" placeholder="E.g. AUTHENTIC" value="<?php echo $comment; ?>"></td>
<td><input type="text" name="transaction_ref[]" id="transaction_ref" class="form-control" placeholder="E.g. 23323462646623525" value="<?php echo $transaction_ref; ?>"></td>
<td></td>
</tr>
</table>
...
<tr>
<td><input type="text" name="names[]" id="names" class="form-control" placeholder="Candidate names" value=""></td>
<td><input type="text" name="institution[]" id="institution" class="form-control" placeholder="E.g. University of Lagos" value=""></td>
<td><input type="text" name="qualification[]" id="qualification" class="form-control" placeholder="E.g. BSc" value=""></td>
...
<tr>
<td><input type="text" name="grade[]" id="grade" class="form-control" placeholder="Ist Class" value=""></td>
<td><input type="text" name="session[]" id="session" class="form-control" placeholder="E.g. 2009/2010" value=""></td>
<td><input type="text" name="comment[]" id="comment" class="form-control" placeholder="E.g. AUTHENTIC" value=""></td>
<td><input type="text" name="transaction_ref[]" id="transaction_ref" class="form-control" placeholder="E.g. 23323462646623525" value=""></td>
<td></td>
</tr>
</table>
...
<input type="text" name="invoice_attachment" id="invoice_attachment" class="form-control" placeholder="Note on invoice attachment" value="<?php check_inputted("invoice_attachment", $invoice_attachment); ?>">
</div>
</div>
...
$in_progress = $value_array[2];
?>
<tr class="sub-right-summary-row" id="right-summary-row<?php echo $e; ?>">
<td class="sub-right-summary-cell" id="right-summary-td<?php echo $e; ?>"><?php echo $e; ?></td>
...
if($e > 1){
?>
<button type="button" class="btn gen-btn del-sub-right-summary-cat" lang="right-summary-row<?php echo $e; ?>" onclick="javascript: delete_right_summary(this.lang);"><i class="fa fa-minus"></i></button>
<?php
}
?>
</td>
...
a++;
$(".summary-list").append("<tr class=\"sub-summary-row\" id=\"summary-row" + a + "\"><td class=\"sub-summary-cell\" id=\"summary-td" + a + "\">" + a + "</td><td><table class=\"table\"><tr><th class=\"gen-title\">Names</th><th class=\"gen-title\">Institution</th><th class=\"gen-title\">Qualification</th><th class=\"gen-title\">Course</th></tr><tr><td><input type=\"text\" name=\"names[]\" id=\"names\" class=\"form-control\" placeholder=\"Candidate names\" value=\"\"></td><td><input type=\"text\" name=\"institution[]\" id=\"institution\" class=\"form-control\" placeholder=\"E.g. University of Lagos\" value=\"\"></td><td><input type=\"text\" name=\"qualification[]\" id=\"qualification\" class=\"form-control\" placeholder=\"E.g. BSc\" value=\"\"></td><td><input type=\"text\" name=\"course[]\" id=\"course\" class=\"form-control\" placeholder=\"E.g. Accounting\" value=\"\"></td><td></td></tr><tr><th class=\"gen-title\">Grade</th><th class=\"gen-title\">Session</th><th class=\"gen-title\">Comment</th><th class=\"gen-title\">Transaction Ref.</th></tr><tr><td><input type=\"text\" name=\"grade[]\" id=\"grade\" class=\"form-control\" placeholder=\"Ist Class\" value=\"\"></td><td><input type=\"text\" name=\"session[]\" id=\"session\" class=\"form-control\" placeholder=\"E.g. 2009/2010\" value=\"\"></td><td><input type=\"text\" name=\"comment[]\" id=\"comment\" class=\"form-control\" placeholder=\"E.g. AUTHENTIC\" value=\"\"></td><td><input type=\"text\" name=\"transaction_ref[]\" id=\"transaction_ref\" class=\"form-control\" placeholder=\"E.g. 23323462646623525\" value=\"\"></td><td></td></tr></table></td><td><button type=\"button\" class=\"btn gen-btn del-sub-summary-cat\" lang=\"summary-row" + a + "\" onclick=\"javascript: delete_summary(this.lang);\"><i class=\"fa fa-minus\"></i></button></td></tr>");
});

$(".add-new-right-summary").click(function(){
e++;
$(".right-summary-list").append("<tr class=\"sub-right-summary-row\" id=\"right-summary-row" + e + "\"><td class=\"sub-right-summary-cell\" id=\"right-summary-td" + e + "\">" + e + "</td><td><input type=\"text\" name=\"batch_no[]\" id=\"batch_no\" class=\"form-control\" placeholder=\"E.g. 3\" value=\"\"></td><td><input type=\"text\" name=\"received_job[]\" id=\"received_job\" class=\"form-control\" placeholder=\"E.g. 5\" onkeyup=\"javascript: only_no(this);\" onchange=\"javascript: only_no(this);\" value=\"\"></td><td><input type=\"text\" name=\"in_progress[]\" id=\"in_progress\" class=\"form-control\" placeholder=\"E.g. 2\" onkeyup=\"javascript: only_no(this);\" onchange=\"javascript: only_no(this);\" value=\"\"></td><td><button type=\"button\" class=\"btn gen-btn del-sub-right-summary-cat\" lang=\"right-summary-row" + e + "\" onclick=\"javascript: delete_right_summary(this.lang);\"><i class=\"fa fa-minus\"></i></button></td></tr>");
});
...
var sub_right_summary_row = document.getElementsByClassName("sub-right-summary-row");
var sub_right_summary_cell = document.getElementsByClassName("sub-right-summary-cell");
var del_sub_right_summary_cat = document.getElementsByClassName("del-sub-right-summary-cat");
var i;
for(i = 0; i < sub_right_summary_row.length; i++){
e = i+1;
f = i-1;
sub_right_summary_row[i].id = "right-summary-row" + e;
sub_right_summary_cell[i].id = "right-summary-td" + e;
sub_right_summary_cell[i].innerHTML = e;
if(i > 0){
del_sub_right_summary_cat[f].lang = "right-summary-row" + e;
}
}
}
