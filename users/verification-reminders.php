...
$activity = "Deleted {$i} Verification reminder(s).";
...
echo "<div class='success'>{$i} verification reminder(s) successfully deleted.</div>";
}else{
echo "<div class='not-success'>Error. Unable to delete verification reminder(s).</div>";
}
...
redirect("{$directory}{$admin}verification-reminders?pn={$pn}");
}
...
redirect("{$directory}{$admin}verification-reminders?pn={$pn}&manage_images={$manage_images}");
}
...
///=====Send mail==================//
$to = $client_email;
$subject = "Verification Reminder [#{$resend}]";
...
echo "<div class=\"success\">Verification reminder successfully sent</div>";
}
///======================================================//
...
/////////////========================Update Reminder=====================/////////
if($_SERVER["REQUEST_METHOD"] == "POST" && !empty($edit) && !empty($request_id) && !empty($client) && !empty($completion_date) && !empty($attention) && !empty($details_category)){
...
if($act){
$error = 0;
echo "<div class='success'>Verification reminder successfully updated.</div>";
}else{
echo "<div class='not-success'>Error. Unable to update verification reminder.</div>";
}
}
///////////////////////////////////////////////////////////////////////////////

/////////////========================Update Reminder Images=====================/////////
...
$error = 0;
$_SESSION["msg"] = "<div class='success'>Verification reminder images successfully updated.</div>";
redirect("{$directory}{$admin}verification-reminders?pn={$pn}&manage_images={$manage_images}");
}
///////////////////////////////////////////////////////////////////////////////
...
$where = "WHERE cover_letter_type = '8'";
...
$where .= (!empty($request_id))?" AND request_id = '{$request_id}'":"";
...
$page_link = "{$admin}verification-reminders?pn=";
$link_suffix = "";
...
<div class="page-title">Verification Reminders <a href="format/verification-data.xlsx" class="btn gen-btn float-right" style="margin-left:10px;"><i class="fa fa-download" aria-hidden="true"></i> Download Verification Format</a><a href="<?php echo $admin; ?>verification-reminders?add=1" class="btn gen-btn general-link float-right">New Verification Reminder</a></div>

<form action="<?php echo $admin; ?>verification-reminders" name="search_form" class="general-form" id="form-div" method="post" runat="server" autocomplete="off" enctype="multipart/form-data">
...
?>
<form action="<?php echo $admin; ?>verification-reminders" class="general-form" id="form-div" method="post" runat="server" autocomplete="off" enctype="multipart/form-data" style="overflow-x:auto;">
...
<td><a href="<?php echo $admin; ?>verification-reminders?edit=<?php echo $letter_id; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn general-link" title="Edit verification reminder #<?php echo $letter_id; ?>"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a></td>
<td><a href="<?php echo $admin; ?>verification-reminders?view=<?php echo $letter_id; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn general-link" title="View verification reminder #<?php echo $letter_id; ?>"><i class="fa fa-eye" aria-hidden="true"></i> View</a></td>
<td><a href="<?php echo $admin; ?>verification-reminders?manage_images=<?php echo $letter_id; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn" title="Manage verification reminder #<?php echo $letter_id; ?> images"><i class="fa fa-file-image-o" aria-hidden="true"></i> Manage</a></td>
<td><a href="<?php echo $admin; ?>verification-reminders?download=<?php echo $letter_id; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn" title="Download verification reminder #<?php echo $letter_id; ?>"><i class="fa fa-download" aria-hidden="true"></i> Download</a></td>
...
?>
<tr><td colspan="10"><input class="sub-del" type="submit" value=" "><button type="button" class="btn del-btn gen-btn float-right"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete selected reminder(s)</button></td></tr>
</tbody>
</table>
</form>
<?php
...
echo "<div class='not-success'>No verification reminders found at the moment.</div>";
}
...
?>
<div class="back">
<a href="<?php echo $admin; ?>verification-reminders?pn=<?php echo $pn; ?>" class="btn gen-btn"><i class="fa fa-arrow-left"></i> Back to view verification reminders</a>
</div>

<div class="page-title">View Verification Reminder Images</div><br>
<?php
...
<form action="<?php echo $admin; ?>verification-reminders" class="form-<?php echo $count_img; ?>" method="post" runat="server" autocomplete="off" enctype="multipart/form-data">
...
?>
<form action="<?php echo $admin; ?>verification-reminders" method="post" runat="server" autocomplete="off" enctype="multipart/form-data">
<input type="hidden" name="manage_images" value="<?php echo $manage_images; ?>"> 
<input type="hidden" name="pn" value="<?php echo $pn; ?>"> 
...
<div class="back"><a href="<?php echo $admin; ?>verification-reminders?pn=<?php echo $pn; ?>" class="btn gen-btn general-link"><i class="fa fa-arrow-left"></i> Back to verification reminders</a></div>
...
<div class="view-title">Agent:  <b><?php echo $client_details; ?></b> &nbsp;&nbsp; Reminder ID: <b><?php echo $view; ?></b> &nbsp;&nbsp; Request ID: <b><?php echo $request_id; ?></b></div>
...
<tr><th>RE:</th><td><?php echo $re; ?></td><th>Attachment:</th><td><?php echo $invoice_attachment; ?></td></tr>
...
<div>
<form action="<?php echo $admin; ?>verification-reminders" class="general-form" id="form-div" method="post" runat="server" autocomplete="off" enctype="multipart/form-data">
<input type="hidden" name="gh" value="1"> 
...
<a href="<?php echo $admin; ?>verification-reminders?edit=<?php echo $view; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn general-link float-right" title="Edit this cover letter"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
</form>
</div>
...
echo "<div class='not-success'>This verification reminder does not exist.</div>";
}
}
...
$request_id = $client = $completion_date = $attention = $reference_no = $client_department = $client_designation = $re = $invoice_attachment = $signatory = $details_category = "";
if(!empty($edit)){
...
<div class="back">
<a href="<?php echo $admin; ?>verification-reminders?view=<?php echo $edit; ?>&pn=<?php echo $pn; ?>" class="btn gen-btn general-link"><i class="fa fa-arrow-left"></i> Back to view verification reminder</a>
</div>

<div class="page-title"><?php echo $action_title; ?> Verification Reminder</div>

<?php if(!empty($edit)){ ?>

<form action="<?php echo $admin; ?>verification-reminders" class="general-form" id="form-div" method="post" runat="server" autocomplete="off" enctype="multipart/form-data" style="border:1px solid #eee;">
<input type="hidden" name="gh" value="1"> 
...
<input type="hidden" name="verification_reminder" value="1"> 
<?php } ?>
...
<input type="text" name="request_id" id="request_id" class="form-control only-no" placeholder="Request ID" value="<?php check_inputted("request_id", $request_id); ?>">
</div>
</div>
...
<script>
<!--
var conf_text = "verification reminder";
//-->
</script>
